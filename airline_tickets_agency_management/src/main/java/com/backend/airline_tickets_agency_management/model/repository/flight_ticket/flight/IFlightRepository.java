...
public interface IFlightRepository extends JpaRepository<Flight,Long> {
    ...
    @Query(value = "SELECT * FROM flight where flag= 1 and flight_code like %?1%",nativeQuery = true)
    Page<Flight> findByCode(String code, Pageable pageable);
    @Query(value = "SELECT * FROM flight where flag= 1 and flight_price like %?1%",nativeQuery = true)
